...
@section('title', $series->name . ' ' . $seo->sp_title_plus)
@section('meta-title', $series->name . ' ' . $seo->sp_title_plus)
@section('meta-keywords', $seo->keywords)
@section('og-title', $series->name . ' ' . $seo->sp_title_plus)
@section('twitter-title', $series->name . ' ' . $seo->sp_title_plus)
 ...
 <main class="bg-grey">
   <!--archive header-->
    <div class="archive-header pt-10 text-center">
        <div class="container">
            <h1 style="display:none;">{{  $series->name }} {{ $seo->sp_title_plus }}</h1>
