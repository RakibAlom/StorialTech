...
@section('title', $author->name . ' | Bangla PDF Books Download | StorialTech')
@section('meta-title', $author->name . ' | Bangla PDF Books Download | StorialTech')
...
@section('og-title', $author->name . ' | Bangla PDF Books Download | StorialTech')
@section('twitter-title', $author->name . ' | Bangla PDF Books Download | StorialTech')
...
@section('content')
 ...
 <main class="bg-grey">
    ...
    <div class="archive-header pt-10 text-center">
        <div class="container">
            <h1 style="display:none;">{{  $author->name }} Bangla PDF Book Download</h1>
                ...
                <div class="widget-header-3">
                    <div class="row align-self-center">
                        <div class="col-md-4 align-self-center">
                            <h5 class="widget-title">{{ $author->name }}</h5>
                        </div>
                    </div>
                </div>
                @if($pdfs->count()  == 0)
