...
@section('title', $author->name . ' ' . $seo->sp_title_plus)
@section('meta-title', $author->name . ' ' . $seo->sp_title_plus)
@section('meta-keywords', $seo->keywords)
@section('og-title', $author->name . ' ' . $seo->sp_title_plus)
@section('twitter-title', $author->name . ' ' . $seo->sp_title_plus)
...
@section('content')
 ...
 <main class="bg-grey">
    ...
    <div class="archive-header pt-10 text-center">
        <div class="container">
            <h1 style="display:none;">{{  $author->name }} {{ $seo->sp_title_plus }}</h1>
