...
@section('title', $category->name . ' | Blog | StorialTech')
@section('meta-title', $category->name . ' | Blog | StorialTech')
@section('meta-keywords', $setting->keywords)
@section('og-title', $category->name . ' | Blog | StorialTech')
@section('twitter-title', $category->name . ' | Blog | StorialTech')
...
@section('content')
 ...
 <main class="bg-grey">
    ...
    <div class="archive-header pt-10 text-center">
        <div class="container">
            <h1 style="display:none;">{{ $category->name }} Blog - StorialTech</h1>
                ...
                <div class="widget-header-3">
                    <div class="row align-self-center">
                        <div class="col-md-4 align-self-center">
                            <h5 class="widget-title">{{ $category->name }} Blog</h5>
                        </div>
                    </div>
                </div>
                @if($blogs->count()  == 0)
