    ...
    <div class="layout-px-spacing">
        ...
        <div class="page-header">
            <div class="page-title">
                <h3>YOUTUBE MOVIE TRASH LIST</h3>
            </div>
        </div>
                                        ...
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-dark btn-sm dropdown-toggle dropdown-toggle-split" id="dropdownMenuReference1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-reference="parent">
                                              ...
                                              <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                                <a class="dropdown-item active-alert" href="{{ route('admin.active.youtube-movie', $item->id) }}">Get Back</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item delete-alert" href="{{ route('admin.permanent-delete.youtube-movie', $item->id) }}">Delete</a>
                                              </div>
                                        </div>
                                    </td>
                                </tr>
