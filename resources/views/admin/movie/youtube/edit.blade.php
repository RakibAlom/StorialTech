                ...
                <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                            <form id="contact" class="section contact" action="{{ route('admin.update.youtube-movie', $movie->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="info">
                                    <h5 class="">Edit Youtube Movie</h5>
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control mb-4 @error('name') is-invalid @enderror" name="name" id="name" placeholder="ex: movie name" id="name" value="{{ $movie->name }}" required>
                                                        @error('name')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control mb-4 @error('elink') is-invalid @enderror" name="elink" id="elink" placeholder="ex: enter embeded link" id="name" value="{{ $movie->elink }}" required>
                                                        @error('elink')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <img class="img-thumbnail" src="{{ asset('storage/app/public/'.$movie->thumbnail) }}" alt="{{ $movie->name }}" id="photo">
                                                    </div>
                                                </div>

                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <button class="btn btn-success btn-lg btn-block font-weight-bold">UPDATE YOUTUBE MOVIE</button>
                                                    </div>
                                                </div>
