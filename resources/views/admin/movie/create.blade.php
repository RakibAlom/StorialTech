                ...
                <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                            <form id="contact" class="section contact" action="{{ route('admin.store.movie') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="info">
                                    <h5 class="">New Movie</h5>
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <table class="table table-sm bg-white table-bordered" id="table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="quality[]" class="form-control @error('quality[]') is-invalid @enderror" name="quality[]" id="quality[]" placeholder="ex: enter download link" id="quality[]" required>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control @error('size[]') is-invalid @enderror" name="size[]" id="size[]" placeholder="ex: 1.2 GB" id="size[]" value="{{ old('size[]') }}">
                                                                @error('size[]')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control mb-4 @error('keywords') is-invalid @enderror" name="keywords" id="keywords" value="{{ old('keywords') }}" placeholder="ex: movie keywords" rows="1">
                                                        @error('keywords')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <button class="btn btn-success btn-lg btn-block font-weight-bold">PUBLISH MOVIE</button>
                                                    </div>
                                                </div>
