                ...
                <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                            <form id="contact" class="section contact" action="{{ route('admin.update-category.tutorial', $category->id) }}" method="POST">
                                @csrf
                                <div class="info">
                                    <h5 class="text-center">Edit Tutorial Category</h5>
                                    <div class="row">
