                        ...
                        <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                            ...
                            @foreach($categories as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('admin.edit-category.template',$item->id) }}" class="btn btn-info btn-sm">
                                            ...
                                            @if($item->status == 0)
                                              <a class="dropdown-item active-alert" href="{{ route('admin.active-category.template', $item->id) }}">Active</a>
                                            @else
                                              <a class="dropdown-item deactive-alert" href="{{ route('admin.deactive-category.template', $item->id) }}">Deactive</a>
                                            @endif
                                              <div class="dropdown-divider"></div>
                                              <a class="dropdown-item trash-alert" href="{{ route('admin.soft-delete-category.template', $item->id) }}">Delete</a>
                                            </div>
                                          </div>
                                    </td>
                                </tr>
