...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        ...
        <div class="page-header">
            ...
            @if(URL::current() == route('admin.faq'))
                <h3>FAQ LIST</h3>
            @endif
            </div>
        </div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                              <a class="dropdown-item" href="{{ route('admin.edit.faq', $item->id) }}">Edit</a>

                                            @if($item->status == 0)
                                              <a class="dropdown-item active-alert" href="{{ route('admin.active.faq', $item->id) }}">Active</a>
                                            @else
                                              <a class="dropdown-item deactive-alert" href="{{ route('admin.deactive.faq', $item->id) }}">Deactive</a>
                                            @endif
                                              <div class="dropdown-divider"></div>
                                              <a class="dropdown-item trash-alert" href="{{ route('admin.soft-delete.faq', $item->id) }}">Delete</a>
                                            </div>
                                          </div>
                                    </td>
                                </tr>
