                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                              <a class="dropdown-item active-alert" href="{{ route('admin.active-category.story', $item->id) }}">Get Back</a>
                                              <div class="dropdown-divider"></div>
                                              <a class="dropdown-item delete-alert" href="{{ route('admin.permanent-delete-category.story', $item->id) }}">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
