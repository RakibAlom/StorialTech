            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h4>
                            Comments ({{ $story->comment->count() + $story->commentreply->count() }})
                        </h4>
                    </div>
                </div>
            </div>
            <div class="widget-content widget-content-area">
                <form action="{{ route('comment.story', $story->id) }}" method="POST">
                    @csrf
                ...
                <div class="col-md-11 col-10">
                    <div class="comment-text">
                        ...
                        <a href="javascript:void(0);" class="text-primary collapsible mr-2">edit</a>
                            <form class="mt-3 content" action="{{ route('update-comment.story', $comment->id) }}" style="display: none;" method="POST">
                                @csrf
                                <div class="input-group mb-4">
                            ...
                            <a href="{{ route('delete-comment.story', $comment->id) }}" class="text-danger delete-alert mr-2">delete</a>
                            ...
                            <div class="col-md-11 col-10">
                                <div class="comment-text">
                                    ...
                                    @if($user->id == $reply->user->id)
                                        ...
                                        <form class="mt-3 content" action="{{ route('update-reply-comment.story', $reply->id) }}" style="display: none;" method="POST">
                                            @csrf
                                            <div class="input-group mb-4">
                                        ...
                                        <a href="{{ route('delete-reply-comment.story', $reply->id) }}" class="text-danger delete-alert ml-2">delete</a>
