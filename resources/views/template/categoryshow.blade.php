...
@section('title', $category->name . ' | Website Template | StorialTech')
@section('meta-title', $category->name . ' | Website Template | StorialTech')
...
@section('og-title', $category->name . ' | Website Template | StorialTech')
@section('twitter-title', $category->name . ' | Website Template | StorialTech')
...
@section('content')
 ...
 <main class="bg-grey">
    ...
    <div class="archive-header pt-10 text-center">
        <div class="container">
            <h1 style="display:none;">{{ $category->name }} Website Template Free Download</h1>
                ...
                <div class="widget-header-3">
                    <div class="row align-self-center">
                        <div class="col-md-4 align-self-center">
                            <h5 class="widget-title">{{ $category->name }} Template</h5>
                        </div>
                    </div>
                </div>
