...
?>
	<div class="installer-container">
		...
		<?php if(validation_errors()) { ?>
            ...
            <?php } else { ?>
			<div class="alert alert-danger">It seems that you have unlinked the domain from your previous license. Please transfer your license to this domain and re-enter it here, or provide another license to continue.</div>
			<?php } ?>
			</div>
		<div class="tabs-area">
			<form method="post">
