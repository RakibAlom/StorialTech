<div class="p-0 container-fluid">
    ...
    <span class="mb-3">Currently editing the account of <?php echo $this_user['username']; ?></span>
            ...
            <form method="POST">
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo_if('is-invalid', form_error('username')); ?>" type="text" name="username" id="username" value="<?php echo set_value('username', $this_user['username']); ?>" placeholder="Choose A Username" />
                    </div>
                </div>
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo_if('is-invalid', form_error('email')); ?>" type="email" name="email" id="email" value="<?php echo set_value('email', $this_user['email']); ?>" placeholder="Choose A E-Mail" />
                    </div>
                </div>
                <div class="mb-3">
                    <div class="form-group">
