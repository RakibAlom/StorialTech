            ...
            <form method="POST">
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo_if('is-invalid', form_error('tld')); ?>" type="text" name="tld" id="tld" value="<?php echo set_value('tld'); ?>" placeholder="Enter the Domain Extension" />
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo_if('is-invalid', form_error('price')); ?>" type="number" name="price" id="price" value="<?php echo set_value('price'); ?>" placeholder="Price in USD" />
