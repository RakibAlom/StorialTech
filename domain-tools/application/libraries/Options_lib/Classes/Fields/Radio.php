            ...
            <div class="py-2 form-group">
                ...
                <?php foreach($this->field['choices'] as $value => $label) { ?>
                    ...
                    <div class="form-check">
                        <input id="<?php echo $value; ?>" class="<?php echo join( ' ', $this->dom['classes'] ); ?>" <?php echo $this->value($value) ?> type="radio" name="key-<?php echo $this->key; ?>" value="<?php echo $value ?>" />
        ...
        ?>
            <div class="py-2 form-group">
                ...
                <?php foreach($this->field['choices'] as $value => $label) { ?>
                    ...
                    <div class="form-check">
                        <input x-model="data.items[index]['<?php echo $this->key ?>']" :id="'<?php echo $value; ?>' + '-' + index" class="<?php echo join( ' ', $this->dom['classes'] ); ?>" x-bind:class="(data.errors && data.errors['<?php echo $this->key ?>-' + index]) && 'is-invalid'" :checked="item['<?php echo $this->key ?>'] == '<?php echo $value ?>'" type="radio" :name="'key-<?php echo $this->repeater['key'] ?>[' + index + '][<?php echo $this->key ?>]'" value="<?php echo $value ?>" />
