        ...
        ?>
            <div class="py-2 form-group">
                ...
                <div class="form-check form-switch form-switch-md float-end">
                    <input id="<?php echo $this->dom['id']; ?>" class="<?php echo join( ' ', $this->dom['classes'] ); ?>"  <?php echo $this->value() ?> name="key-<?php echo $this->key; ?>" type="checkbox">
                </div>
    ...
    public function repeater_render() {
        ...
        ?>
            <div class="py-2 form-group">
                ...
                <div class="form-check form-switch form-switch-md float-end">
                    <input x-model="data.items[index]['<?php echo $this->key ?>']" value="checked" :id="'<?php echo $this->dom['id']; ?>' + '-' + index" class="<?php echo join( ' ', $this->dom['classes'] ); ?>" :checked="item['<?php echo $this->key ?>'] ? true : false" :name="'key-<?php echo $this->repeater['key'] ?>[' + index + '][<?php echo $this->key ?>]'" type="checkbox">
                </div>
