...
use App\Models\Seo\SeoWebstory;
use Illuminate\Http\Request;

class WebstorySeoController extends Controller
{
    public function index()
    {
        $seo = SeoWebstory::first();
        return view ('admin.seo.webstoryseo', compact('seo'));
    }

    public function store()
    {
        $seo = SeoWebstory::create($this->validateData());
